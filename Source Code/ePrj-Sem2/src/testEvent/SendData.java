 ...
 * @author Dat ThinkPad
 */
public class SendData extends javax.swing.JFrame implements Runnable{

    /**
     * Creates new form SendData
     */
    Library.getIDFromFrame objReceiver;
    ...
    public void addReceiver(Library.getIDFromFrame objReceiver)
    {
    ...
    public void checkTextField()
    {
        txtData.getDocument().addDocumentListener(new DocumentListener() {
            ...
            {
                objReceiver.receiveData(txtData.getText());
            }
        });
