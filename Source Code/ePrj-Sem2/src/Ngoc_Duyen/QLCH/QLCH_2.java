 ...
 * @author Dell
 */
public class QLCH_2 extends javax.swing.JFrame {
...
//                row.add(rs.getDouble("StatusApa"));
//                row.add(rs.getDouble("PriceApa"));
//                row.add(rs.getDouble("IDSupApa"));
...
//                data.add(row);                
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLCH_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
